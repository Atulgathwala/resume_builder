...
const FreeTextTemplate2 = () => {
  return (
    <div className="h-[86%]  w-[34%] bg-white flex justify-center items-center overflow-hidden">
      <div className="h-full w-full p-2 font-sans flex flex-col overflow-hidden leading-[1.2]">
        ...
        <header className="text-center pb-1 border-b">
          ...
          <p className="text-[9px] text-gray-500">Address | Mail | Website</p>
        ...
        <section className="mt-1">
          ...
          <p className="text-[9px] px-2 mt-1 text-gray-700 leading-tight pl-5">
        ...
        <div className="flex-grow overflow-hidden space-y-2 mt-1">
          ...
          <section>
            ...
            <div className="grid grid-cols-3 text-[9px] text-gray-700 pl-5 mt-1">
          ...
          <section>
            ...
            <div className="px-2 mt-1 text-gray-700 pl-5 text-[9px] space-y-1">
              <div>
          ...
          <section>
            ...
            <div className="px-2 mt-1 text-gray-700 text-[9px] pl-5 space-y-1">
              <div>
                <div className="flex justify-between font-semibold text-[10px]">
                  <p>
          ...
          <section>
            ...
            <div className="pl-8">
              <ul className="list-disc  text-[9px] text-gray-700 mt-1  space-y-[2px]">
