    ...
    <section className="h-[86%]  w-[34%] bg-white flex justify-center items-start overflow-hidden">
      <div className="h-full w-full flex">
        ...
        <div className="w-[36%] bg-[#3a3f47] text-white px-4 py-5 flex flex-col gap-5 overflow-hidden">
          ...
          {/* CONTACT */}
          <div>
            <h2 className="text-[10px] font-semibold border-b border-white/30 pb-1">
              CONTACT
            </h2>
        ...
        <div className="w-[64%] bg-white px-5 py-5 flex flex-col gap-4 overflow-hidden">
          ...
          <div>
            ...
            <p className="text-[9px] mt-1 text-gray-600 tracking-wide">
              Marketing Manager
            </p>
          </div>
          ...
          {/* ABOUT */}
          <div>
            <h2 className="text-[10px] font-bold text-[#333] border-b border-gray-300 pb-1">
              ABOUT ME
            </h2>
